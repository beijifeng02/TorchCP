...
def build_dataset(data_dir="/mnt/sharedata/ssd/common/datasets/", num_workers=8, train=False):
    ...
    trainloader = torch.utils.data.DataLoader(dataset=trainset, batch_size=1024, num_workers=num_workers)
